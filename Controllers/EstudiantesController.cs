...
namespace EscuelaAppSimbana.Controllers
{
    ...
    public class EstudiantesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("estudiante_id,nombre,apellido,fecha_nacimiento,grado")] Estudiante estudiante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("estudiante_id,nombre,apellido,fecha_nacimiento,grado")] Estudiante estudiante)
        {
